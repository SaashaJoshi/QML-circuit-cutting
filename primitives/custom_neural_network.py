...
class CustomNeuralNetwork(ABC):
    ...
    def _validate_backward_output(
        ...
        #     input_grad = None
        if input_grad is not None and original_shape and len(original_shape) >= 3:
        ...
        #     weight_grad = None
        if weight_grad is not None and original_shape and len(original_shape) >= 3:
    ...
    def backward(
        ...
        # print(self._validate_backward_output(input_grad, weight_grad, shape))
